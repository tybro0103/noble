...
var Hci = function(deviceId) {
  this._socket = new BluetoothHciSocket();
  this._isDevUp = null;
  this._state = null;
  this._deviceId = null;
  this._givenDeviceId = deviceId;
...
Hci.prototype.init = function() {
  ...
  var deviceId = this._givenDeviceId || process.env.NOBLE_HCI_DEVICE_ID ? parseInt(process.env.NOBLE_HCI_DEVICE_ID, 10) : undefined;
